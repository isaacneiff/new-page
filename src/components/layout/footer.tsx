    ...
    <footer className="bg-muted py-12 text-muted-foreground">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-6">
          <a href="mailto:juliana.nutri@email.com" aria-label="Email" className="hover:text-primary transition-colors">
            <Mail size={24} />
          </a>
        ...
        <p className="text-sm">
          &copy; {currentYear} NutriLife Academia. Todos os direitos reservados.
        </p>
