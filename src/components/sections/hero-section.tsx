...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative h-screen min-h-[600px] flex items-center justify-center text-center text-white overflow-hidden bg-cover bg-no-repeat bg-center"
    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-4 py-16">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 leading-tight drop-shadow-lg">
          Com a expertise da Dra. Carla Zanelatto, a Zanelatto Academy conecta Saúde, estratégia e ciência.
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl mb-10 max-w-3xl mx-auto drop-shadow-md">
          Mentorias, cursos em SUS e consultoria estatística para sua aprovação com excelência.
        </p>
